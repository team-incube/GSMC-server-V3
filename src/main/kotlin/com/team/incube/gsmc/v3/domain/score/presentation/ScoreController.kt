...
class ScoreController(
    ...
    @Operation(summary = "학급 내 백분위수 조회", description = "현재 인증된 사용자의 학급 내 상위/하위 백분위수를 조회합니다")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
    ...
    @Operation(summary = "학년 내 백분위수 조회", description = "현재 인증된 사용자의 학년 내 상위/하위 백분위수를 조회합니다")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
