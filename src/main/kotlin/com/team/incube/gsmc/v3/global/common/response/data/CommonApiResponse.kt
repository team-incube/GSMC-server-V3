...
data class CommonApiResponse<T>(
    ...
    companion object {
        ...
        fun <T> success(message: String, data: T): CommonApiResponse<T> =
            CommonApiResponse(
                status = HttpStatus.OK,
                code = HttpStatus.OK.value(),
                message = message,
        ...
        fun <T> created(message: String, data: T): CommonApiResponse<T> =
            CommonApiResponse(
                status = HttpStatus.CREATED,
                code = HttpStatus.CREATED.value(),
                message = message,
        ...
        fun error(message: String, status: HttpStatus): CommonApiResponse<Nothing> =
            CommonApiResponse(
                status = status,
                code = status.value(),
                message = message
