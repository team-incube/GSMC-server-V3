...
data class AuthTokenResponse(
    ...
    @field:Schema(description = "Access Token 유효기간", example = "2025-11-12T10:12:12.123Z")
    val accessTokenExpiresAt: LocalDateTime,
    @field:Schema(description = "Refresh Token")
    val refreshToken: String,
    @field:Schema(description = "Refresh Token 유효기간", example = "2025-11-19T10:12:12.123Z")
