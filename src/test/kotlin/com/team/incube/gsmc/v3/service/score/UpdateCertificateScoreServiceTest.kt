...
import com.team.incube.gsmc.v3.domain.score.service.impl.UpdateCertificateScoreServiceImpl
...
class UpdateCertificateScoreServiceTest :
    BehaviorSpec({
        data class TestData(
            val scoreRepo: ScoreExposedRepository,
            val fileRepo: FileExposedRepository,
            val currentMemberProvider: CurrentMemberProvider,
            val service: UpdateCertificateScoreServiceImpl,
        )
        ...
        fun ctx(): TestData {
            ...
            val service = UpdateCertificateScoreServiceImpl(scoreRepo, fileRepo, currentMemberProvider)
